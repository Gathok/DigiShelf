...
val CustomFileOpenIcon: ImageVector
    get() {
        if (_CustomFileOpenIcon != null) {
            return _CustomFileOpenIcon!!
        }
        _CustomFileOpenIcon = ImageVector.Builder(
            name = "File_open",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _CustomFileOpenIcon: ImageVector? = null
