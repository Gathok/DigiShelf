...
val CustomCloudSyncIcon: ImageVector
    get() {
        if (_CustomCloudSyncIcon != null) {
            return _CustomCloudSyncIcon!!
        }
        _CustomCloudSyncIcon = ImageVector.Builder(
            name = "Cloud_download",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _CustomCloudSyncIcon: ImageVector? = null
